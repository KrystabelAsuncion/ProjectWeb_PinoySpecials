                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            ...
                                            <div class="card-footer" style="background: transparent; padding: 0;">
                                                <a href="<?php echo e(route('recipe_view')); ?>" class="btn btn-outline-secondary mt-3 text-muted fs-5 ms-2" type="button">View Recipe</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="row my-4 align-items-center d-flex justify-content-center">
                    ...
                    <div class="col-lg-3 p-4 me-3 shadow" style=" border-radius: 20px;">
                        ...
                        <div class="row mx-auto justify-content-center mt-3">
                            <a href="<?php echo e(route('logout')); ?>" type="button" class="btn btn-outline-dark"
                        ...
                        <div class="row shadow p-4 fs-2" style="width: 500px; border-radius: 20px;">
                            <form action="" method="">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="email" class="form-control fs-3" id="email" placeholder="Email" value="<?php echo e(old('email')); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="usn" class="form-label">Username</label>
                                    <input type="text" class="form-control fs-3" id="usn" placeholder="Username" value="<?php echo e(old('username')); ?>">
                                </div>

                                <div class="mb-3">
                                    <label for="pw" class="form-label">Password</label>
                                    <input type="password" class="form-control fs-3" id="pw" placeholder="Password" value="<?php echo e(old('password')); ?>" disabled>
                                </div>
...
<?php echo $__env->make('Auth.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MARKBEL\OneDrive\Nitro 5\Nitro 5 My Documents\ASUNCION_GROUPACT\Project Web\Final-PS\resources\views/Auth/home.blade.php ENDPATH**/ ?>